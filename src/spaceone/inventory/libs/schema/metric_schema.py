...
'aws': [{"key": "cpu.utilization", "metric": "CPUUtilization"},
               ...
               {"key":"network.received_throughput", "metric": "NetworkPacketsIn"},
               {"key":"network.received_pps", "metric": "NetworkIn"},
               {"key":"network.sent_throughput", "metric": "NetworkPacketsOut"},
               {"key":"network.sent_pps", "metric": "NetworkOut"}],
